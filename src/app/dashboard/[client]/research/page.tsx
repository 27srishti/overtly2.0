        ...
        <div className="flex-1 overflow-auto max-h-full">
          <ScrollArea className="h-full flex flex-col w-full">
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              ...
              The new sidebar layout is quite promising, dont you think? Hey,
              Ive been diving deep into the latest mockups and UI specs. The new
              sidebar layout is quite promising, dont you think? Hey, Ive been
              diving deep into the latest mockups and UI specs. The new sidebar
              layout is quite promising, dont you think?
            </div>
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
              ...
              content and enhancing navigation. Absolutely, its a definite
              improvement in terms of organizing content and enhancing
              navigation.
            </div>
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              I agree. The structure feels more intuitive. How about the color
              palette? Do you think it resonates well with our target users? I
              agree. The structure feels more intuitive. How about the color
            ...
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
              ...
              contrast, especially for users with visual impairments. The colors
              are aesthetically pleasing, but we should consider accessibility
              aspects. Maybe adjust the saturation for better contrast,
            ...
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              ...
              about onboarding strategies? Simplification sounds like a good
              approach. We want the interface to be user-friendly even for
              first-time users. Have you thought about onboarding strategies?
            </div>
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
            ...
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              ...
              from the start. Hows the timeline looking for the next steps? That
              sounds comprehensive. Lets aim for a seamless user experience from
              the start. Hows the timeline looking for the next steps?
            </div>
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
            ...
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              ...
              crucial to iterate quickly based on real-world insights. Great.
              Ill start gathering feedback from the team in parallel. Its
              crucial to iterate quickly based on real-world insights.
            </div>
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
              Absolutely. Lets remain agile and responsive to ensure we deliver
              a product that delights our users. Absolutely. Lets remain agile
              and responsive to ensure we deliver a product that delights our
              users.
            </div>
            <div className="rounded-[30px] p-5 max-w-[90%] mb-5 self-start">
              Sounds like a plan. I appreciate your thorough approach to this.
              Looking forward to seeing our progress next week! Sounds like a
              plan. I appreciate your thorough approach to this. Looking forward
              to seeing our progress next week!
            </div>
            <div className="bg-[#CDCDCD] bg-opacity-25 rounded-[30px] p-5 max-w-[40%] mb-5 self-end">
